...
import 'package:venturo_core/features/forgot_password/view/ui/forgot_password_fourth.dart';

class ForgotPasswordThird extends StatelessWidget {
  ForgotPasswordThird({Key? key}) : super(key: key);
                      ...
                      child: const Column(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(
                            ...
                            child: Text(
                              'Masukan 4 kode yang sudah dikirim ke Emailmu.',
                                    ...
                                    border: Border(
                                      ...
                                      right: BorderSide(
                                          color:
                                              Color.fromRGBO(239, 240, 245, 1)),
                                      bottom: BorderSide(
                                          width: 1, color: Color(0xFF0B0C0D)),
                                    ),
                                  ),
                                  child: const Column(
                                    mainAxisSize: MainAxisSize.min,
